...
public class ItemIngot extends ModMetaItem{
    ...
    private static final String[] extensions = {"copper", "tin", "silver", "lead", "nickel", "invar"};
    private static final Integer[] colors = {0xef7e0c, 0xdcf3f3, 0xc1dede, 0x30193c, 0xa3a375, 0xc2c2a3};
